...
public class FreeTrialNoPaymentCollectedTest extends WebDriverUtility {
	...
	public void verifyCheckoutWithCC() throws MalformedURLException, InterruptedException {
		...
		product.createRecurrProdTrialNoPay();
		product.selectTemplate(Template.vintage);
