...
public class CreditCardDuplicatePurchaseTest extends WebDriverUtility {

	String successPage = new String("PayKickstart :: Edit Product");

	@Test(invocationCount = 1)
	public void verifyDuplicateCheckoutWarningCC() throws MalformedURLException, InterruptedException {
		...
		check.checkIsWarningPresent();
		check.closeDuplicateWarning();
		check.checkoutCreditCard();
		driver.quit();
	}
