...
public class RefundCreditCardAuthorizeNetTest extends WebDriverUtility {
	String successPage = new String("PayKickstart :: Edit Product");

	@Test(invocationCount = 1)
	public void refund() throws MalformedURLException, InterruptedException {
		...
		refundPage.refund(sameCampaign);
		refundPage.checkIsRefund(sameCampaign);
