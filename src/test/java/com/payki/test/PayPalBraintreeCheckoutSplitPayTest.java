...
public class PayPalBraintreeCheckoutSplitPayTest extends WebDriverUtility {

	String successPage = new String("PayKickstart :: Edit Product");

	@Test(invocationCount = 1)
	public void verifyPayPalBraintreeCheckoutSplitPay() throws MalformedURLException, InterruptedException {
...
//		campaign.removeCampaignByMatchingString();
		...
		check.checkoutPayPalBraintreeSplit();
		driver.quit();
	}
