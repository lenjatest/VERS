...
public class CreateProductTestPayPalBraintreeCheckout extends WebDriverUtility {

	String successPage = new String("PayKickstart :: Edit Product");

	@Test(invocationCount = 1)
	public void verifyCheckoutWithPayPalBraintree() throws MalformedURLException, InterruptedException {
