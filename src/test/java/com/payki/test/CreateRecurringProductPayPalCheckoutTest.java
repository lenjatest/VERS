...
import com.paykickstart.pages.SubscriptionsPage;

public class CreateRecurringProductPayPalCheckoutTest extends WebDriverUtility {
	...
	public void verifyCreateEditCampaign() throws MalformedURLException, InterruptedException {
		...
		product.createRecurringProduct();
		...
		SubscriptionsPage subsc = new SubscriptionsPage(driver);
		subsc.checkSubscriptionStatus(sameCampaign);
		driver.quit();
	}
